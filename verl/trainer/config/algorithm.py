...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        filter_zero_std_groups (bool): Whether to mask out uid groups whose sequence-score std is at or below threshold.
        filter_zero_std_groups_eps (float): Threshold for considering a uid group's sequence-score std as zero.
    ...
    filter_zero_std_groups_eps: float = 0.0
